...
%%% write files  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
prep_fullwave2_try6_nln_relaxing4(c0,omega0,wX,wY,duration,p0,ppw,cfl,cmap,rhomap-rhos*50,Amap,betamap,incoords,outcoords,icmat)
tic
...
save fullwave_attenuation_lesion2.mat tx1 tx2
